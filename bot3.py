...
stopuser = {}
token = '6766142731:AAFQ2cJwfhTFR2ktBSROmjwu1pjY5pXuJks'
	...
	def my_function():
	  ...
	  "plan": "Free - Not Subscribed",
		...
		if BL == 'Free - Not Subscribed':	
			...
			contact_button = types.InlineKeyboardButton(text="ϟ Programmer - ddfmoto0", url="https://t.me/sandaveX")
...
ϟ Programmer ~ @ddfmoto0 </b>''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="ϟ Our Channel ϟ", url="https://t.me/sandaveX")
		keyboard.add(contact_button)
...
def generate_code(message):
    def my_function():
        ...
        try:
            ...
            pas = 'DD-' + '2024' +'-' + ''.join(random.choices(characters, k=4))
            current_time = datetime.now()
            ...
            msg = f'''<b>ϟ sandaveX checker Code
